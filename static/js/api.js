...
(function() {
    ...
    ;
    (window[CFG]['render'] = window[CFG]['render'] || []).push('6LdYipQUAAAAAG0LMajLOPmLJc24gu3_rsirGI0D');
    window['__google_recaptcha_client'] = true;
    var po = document.createElement('script');
    po.type = 'text/javascript';
    po.async = true;
    po.src = 'https://www.gstatic.com/recaptcha/api2/v1561357937155/recaptcha__en.js';
