...
!function(e, n, t) {
    ...
    function u(e, t, r, o) {
        var s, i, u, f, c = "modernizr", d = l("div"), p = a();
        if (parseInt(r, 10))
            for (; r--; )
                u = l("div"),
                u.id = o ? o[r] : c + (r + 1),
    ...
    function m(e, n, o, s) {
        ...
        for (var f, c, m, g, y, v = ["modernizr", "tspan", "samp"]; !E.style && v.length; )
            f = !0,
            E.modElem = l(v.shift()),
    ...
    function y(e, n, t) {
        ...
        for (var s in e)
            if (e[s]in n)
                ...
                r(o, "function") ? g(o, t || n) : o);
        return !1
    }
    function v(e, n, t, o, s) {
        var i = e.charAt(0).toUpperCase() + e.slice(1)
          , l = (e + " " + P.join(i + " ") + i).split(" ");
        return r(n, "string") || r(n, "undefined") ? m(l, n, o, s) : (l = (e + " " + N.join(i + " ") + i).split(" "),
        y(l, n, t))
    }
    function h(e, n, r) {
        return v(e, t, t, n, r)
